...
public class SimpleMeasure {
   ...
   public enum Centroid {LABEL, CX_PIX, CY_PIX, CZ_PIX, CX_UNIT, CY_UNIT, CZ_UNIT};
   public enum Volume {LABEL, VOLUME_PIX, VOLUME_UNIT};
   public enum Surface {LABEL, SURFACE_PIX, SURFACE_UNIT, SURFACE_CORRECTED, SURFACE_NB_VOXELS};
   public enum Compactness {LABEL, COMP_UNIT, COMP_PIX, COMP_CORRECTED, COMP_DISCRETE, SPHER_PIX, SPHER_UNIT, SPHER_CORRECTED, SPHER_DISCRETE};
   public enum Elipsoid {LABEL, ELL_VOL_UNIT, ELL_SPARENESS, ELL_MAJOR_RADIUS_UNIT, ELL_ELONGATION, ELL_FLATNESS};
   public enum DistanceCentreContour {LABEL, DIST_CENTER_MIN_PIX, DIST_CENTER_MAX_PIX, DIST_CENTER_AVG_PIX, DIST_CENTER_SD_PIX,
       DIST_CENTER_MIN_UNIT, DIST_CENTER_MAX_UNIT, DIST_CENTER_AVG_UNIT, DIST_CENTER_SD_UNIT};
   public enum Feret {LABEL, FERET_UNIT, FERET1_X, FERET1_Y, FERET1_Z, FERET2_X, FERET2_Y, FERET2_Z};
   
   /**
    * Based on class MeasureCentroid
    * 
    * Indices: 
    * 0 LABEL, 1 CX_PIX, 2 CY_PIX, 3 CZ_PIX, 4 CX_UNIT, 5 CY_UNIT, 6 CZ_UNIT
    * 
    */
    ...
    *     
    * Indices: 
    * 0 LABEL, 1 VOLUME_PIX, 2 VOLUME_UNIT
    */
    ...
    *     
    * Indices: 
    * 0 LABEL, 1 SURFACE_PIX, 2 SURFACE_UNIT, 3 SURFACE_CORRECTED, 4 SURFACE_NB_VOXELS
    */
    ...
    *     
    * Indices: 
    * 0 LABEL, 1 COMP_UNIT, 2 COMP_PIX, 3 COMP_CORRECTED, 4 COMP_DISCRETE, 5 SPHER_PIX, 6 SPHER_UNIT, 7 SPHER_CORRECTED, 8 SPHER_DISCRETE
    */
    ...
    *     
    * Indices: 
    * 0 LABEL, 1 ELL_VOL_UNIT, 2 ELL_SPARENESS, 3 ELL_MAJOR_RADIUS_UNIT, 4 ELL_ELONGATION, 5 ELL_FLATNESS
    */
    ...
    *     
    * Indices: 
    * 0 LABEL, 1 DIST_CENTER_MIN_PIX, 2 DIST_CENTER_MAX_PIX, 3 DIST_CENTER_AVG_PIX, 4 DIST_CENTER_SD_PIX, 5 DIST_CENTER_MIN_UNIT, 6 DIST_CENTER_MAX_UNIT, 7 DIST_CENTER_AVG_UNIT, 8 DIST_CENTER_SD_UNIT
    */
    ...
    *     
    * Indices: 
    * 0 LABEL, 1 FERET_UNIT, 2 FERET1_X, 3 FERET1_Y, 4 FERET1_Z, 5 FERET2_X, 6 FERET2_Y, 7 FERET2_Z
    */
